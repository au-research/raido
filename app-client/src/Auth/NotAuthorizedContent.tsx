    ...
    <Card>
      ...
      <CardContent>
        <Typography paragraph>
          "Sign in" again if you want to sign in as a different user, or use a
          different ID Provider.
        </Typography>
...
function AuthzRequestContainer({ accessToken }: { accessToken: string }) {
  ...
  return (
    <Card>
      <CardHeader
        title="Request RAiD Authorisation"
            ...
            {requested && (
              <>
                ...
                <Alert severity="warning">
                  <Typography>
                    Our notification system is not yet implemented. Please send
                    an email to{" "}
                    <a
                      target="_blank"
...
function InstitutionAutocomplete({
  ...
  return (
    <Autocomplete
      ...
      renderInput={(params) => (
        <TextField {...params} required label="Institution" autoFocus={true} />
      )}
    />
  );
}
  ...
  return (
    <HelpPopover
      content={
        <Stack spacing={1}>
          <Typography>
            After you've submitted your request, you will need to contact your
            institution administrator to let them know. (This process will be
            automated in the future).
          </Typography>
          <Typography>
            If you made a mistake when you submitted your request (wrong
            institution or you just want change/add the comment) - re-submit and
            your request will be updated.
          </Typography>
          <ul>
            <li>
              <HelpChip label={"Institution"} />
              The institute you are requesting to be authorized for.
            </li>
            <li>
              <HelpChip label={"Comments / Information"} />
              Any context you'd like to give to the person authorising the
              request. Contact details, reminder about a previous conversation,
              etc.
            </li>
          </ul>
        </Stack>
