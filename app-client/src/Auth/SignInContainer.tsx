import { Google as GoogleIcon, Help as HelpIcon } from "@mui/icons-material";
import {
  Button,
  Card,
  CardContent,
...
import { AustraliaIcon, OrcidIcon } from "Component/Icon";
            ...
            title={
              <>
                <Typography variant="body2" gutterBottom>
                  You can sign in either directly with your personal Google or
                  ORCID account, or via the AAF if your organisation has an
                  agreement.
                </Typography>
                <Typography variant="body2">
                  Once you've signed in and authenticated yourself, you will be
                  able to submit a request for a specific institution to
                  authorize your usage of the RAiD app with their data.
                </Typography>
              </>
            }
          >
