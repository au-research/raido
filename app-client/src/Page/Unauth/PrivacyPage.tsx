...
export function PrivacyPage() {
    ...
    const privacyPolicyLinkButton = (
        <Button href="https://ardc.edu.au/privacy-policy/" target="_blank" variant="text"
    ...
    const supportMailLink = (
        <Button href="mailto:contact@raid.org" variant="text"
                size="small" sx={{minWidth: 0}}>
            contact@raid.org
        </Button>
    )
                ...
                <CardContent>
                    <Stack gap={2}>
                        <Typography variant="body2" color="text.secondary">
                            ...
                            the {privacyPolicyLinkButton} of the Australian Research Data
                            Commons {ardcLinkButton}.
                        </Typography>

                        <Typography variant="body2" color="text.secondary">
                            You can request that your own data be deleted by submitting
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Data from Identity Providers (e.g. AAF, Google)
