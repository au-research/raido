 ...
 */
export function instanceOfRaidCreateRequest(value: object): value is RaidCreateRequest {
...
export function RaidCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RaidCreateRequest {
  ...
  export function RaidCreateRequestToJSON(json: any): RaidCreateRequest {
      return RaidCreateRequestToJSONTyped(json, false);
  }

  export function RaidCreateRequestToJSONTyped(value?: RaidCreateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
