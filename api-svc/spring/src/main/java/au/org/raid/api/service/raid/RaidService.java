...
import static au.org.raid.api.service.raid.MetadataService.mapApi2Db;
...
import static au.org.raid.db.jooq.api_svc.enums.Metaschema.*;
...
public class RaidService {
    ...
    public DenormalisedRaidData getDenormalisedRaidData(
        ...
        return new DenormalisedRaidData(
                RaidoSchemaV1Util.getPrimaryTitle(metadata.getTitles()).getTitle(),
    ...
    private IdentifierHandle parseHandleFromApids(
        ...
        if (parseResult instanceof IdentifierParser.ParseProblems problems) {
    ...
    public void migrateRaidoSchemaV1(
        ...
        String primaryTitle = RaidoSchemaV1Util.getPrimaryTitles(metadata.getTitles()).
                get(0).getTitle();
