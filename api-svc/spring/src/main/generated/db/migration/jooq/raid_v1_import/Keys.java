...
import db.migration.jooq.raid_v1_import.tables.records.FlywaySchemaHistoryRecord;
import db.migration.jooq.raid_v1_import.tables.records.MetadataRecord;
...
public class Keys {
    ...
    public static final UniqueKey<TokenRecord> TOKEN_PKEY = Internal.createUniqueKey(Token.TOKEN, DSL.name("token_pkey"), new TableField[] { Token.TOKEN.NAME }, true);
}
