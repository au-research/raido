  ...
  void mintRaidV1_ReturnsOk() throws Exception {
    ...
    try (MockedStatic<AuthzUtil> authzUtil = Mockito.mockStatic(AuthzUtil.class)) {
      ...
      mockMvc.perform(post("/raid/v1")
        ...
        .andExpect(jsonPath("$.contributors[0].roles[0].id", Matchers.is("https://credit.niso.org/contributor-roles/project-administration/")))
  ...
  void listRaidsV1_ReturnsOk() throws Exception {
    ...
    try (MockedStatic<AuthzUtil> authzUtil = Mockito.mockStatic(AuthzUtil.class)) {
      ...
      mockMvc.perform(get("/raid/v1", handle)
        ...
        .andExpect(jsonPath("$[0].contributors[0].roles[0].id", Matchers.is("https://credit.niso.org/contributor-roles/project-administration/")))
