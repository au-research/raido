  ...
  void mintRaidV1_ReturnsOk() throws Exception {
    ...
    try (MockedStatic<AuthzUtil> authzUtil = Mockito.mockStatic(AuthzUtil.class)) {
      ...
      mockMvc.perform(post("/raid/v1")
        ...
        .andExpect(jsonPath("$.descriptions[0].type", Matchers.is(PRIMARY_DESCRIPTION_TYPE)))
        .andExpect(jsonPath("$.descriptions[0].schemeUri", Matchers.is(DESCRIPTION_TYPE_SCHEME_URI)))
        .andExpect(jsonPath("$.access.type", Matchers.is(ACCESS_TYPE_CLOSED)))
        .andExpect(jsonPath("$.access.schemeUri", Matchers.is(ACCESS_SCHEME_URI)))
        ...
        .andExpect(jsonPath("$.contributors[0].schemeUri", Matchers.is("https://orcid.org/")))
        ...
        .andExpect(jsonPath("$.contributors[0].positions[0].type", Matchers.is("https://github.com/au-research/raid-metadata/blob/main/scheme/contributor/position/v1/leader.json")))
        ...
        .andExpect(jsonPath("$.contributors[0].roles[0].type", Matchers.is("https://credit.niso.org/contributor-roles/project-administration/")))

        .andExpect(jsonPath("$.organisations[0].roles[0].type", Matchers.is("https://github.com/au-research/raid-metadata/blob/main/scheme/organisation/role/v1/lead-research-organisation.json")))
  ...
  void listRaidsV1_ReturnsOk() throws Exception {
    ...
    try (MockedStatic<AuthzUtil> authzUtil = Mockito.mockStatic(AuthzUtil.class)) {
      ...
      mockMvc.perform(get("/raid/v1", handle)
        ...
        .andExpect(jsonPath("$[0].descriptions[0].type", Matchers.is(PRIMARY_DESCRIPTION_TYPE)))
        .andExpect(jsonPath("$[0].descriptions[0].schemeUri", Matchers.is(DESCRIPTION_TYPE_SCHEME_URI)))
        .andExpect(jsonPath("$[0].access.type", Matchers.is(ACCESS_TYPE_CLOSED)))
        .andExpect(jsonPath("$[0].access.schemeUri", Matchers.is(ACCESS_SCHEME_URI)))
        ...
        .andExpect(jsonPath("$[0].contributors[0].schemeUri", Matchers.is("https://orcid.org/")))
        ...
        .andExpect(jsonPath("$[0].contributors[0].positions[0].type", Matchers.is("https://github.com/au-research/raid-metadata/blob/main/scheme/contributor/position/v1/leader.json")))
        ...
        .andExpect(jsonPath("$[0].contributors[0].roles[0].type", Matchers.is("https://credit.niso.org/contributor-roles/project-administration/")))
        .andExpect(jsonPath("$[0].organisations[0].roles[0].type", Matchers.is("https://github.com/au-research/raid-metadata/blob/main/scheme/organisation/role/v1/lead-research-organisation.json")))
