...
public class DescriptionTypeRecord extends UpdatableRecordImpl<DescriptionTypeRecord> implements Record2<Integer, String> {
    ...
    /**
     * Setter for <code>api_svc.description_type.name</code>.
     */
    public DescriptionTypeRecord setName(String value) {
        set(1, value);
        return this;
    }

    /**
     * Getter for <code>api_svc.description_type.name</code>.
     */
    ...
    public Field<String> field2() {
        return DescriptionType.DESCRIPTION_TYPE.NAME;
    }
     ...
     */
    public DescriptionTypeRecord(Integer schemeId, String name) {
        super(DescriptionType.DESCRIPTION_TYPE);
