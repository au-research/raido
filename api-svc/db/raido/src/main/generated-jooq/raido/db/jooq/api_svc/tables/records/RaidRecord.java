...
public class RaidRecord extends UpdatableRecordImpl<RaidRecord> implements Record10<String, Long, String, Integer, String, Boolean, Metaschema, JSONB, LocalDate, LocalDateTime> {
    ...
    @Override
    public RaidRecord values(String value1, Long value2, String value3, Integer value4, String value5, Boolean value6, Metaschema value7, JSONB value8, LocalDate value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RaidRecord(String handle, Long servicePointId, String url, Integer urlIndex, String primaryTitle, Boolean confidential, Metaschema metadataSchema, JSONB metadata, LocalDate startDate, LocalDateTime dateCreated) {
        super(Raid.RAID);
