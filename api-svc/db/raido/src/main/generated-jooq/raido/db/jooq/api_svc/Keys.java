...
public class Keys {
    ...
    public static final UniqueKey<AccessTypeRecord> ACCESS_TYPE_PKEY = Internal.createUniqueKey(AccessType.ACCESS_TYPE, DSL.name("access_type_pkey"), new TableField[] { AccessType.ACCESS_TYPE.SCHEME_ID, AccessType.ACCESS_TYPE.NAME }, true);
    ...
    public static final UniqueKey<DescriptionTypeRecord> DESCRIPTION_TYPE_PKEY = Internal.createUniqueKey(DescriptionType.DESCRIPTION_TYPE, DSL.name("description_type_pkey"), new TableField[] { DescriptionType.DESCRIPTION_TYPE.SCHEME_ID, DescriptionType.DESCRIPTION_TYPE.NAME }, true);
    ...
    public static final UniqueKey<TitleTypeRecord> TITLE_TYPE_PKEY = Internal.createUniqueKey(TitleType.TITLE_TYPE, DSL.name("title_type_pkey"), new TableField[] { TitleType.TITLE_TYPE.SCHEME_ID, TitleType.TITLE_TYPE.NAME }, true);
