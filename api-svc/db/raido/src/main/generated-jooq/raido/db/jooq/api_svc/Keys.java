...
public class Keys {
    ...
    public static final UniqueKey<OrganisationRoleTypeRecord> ORGANISATION_ROLE_TYPE_PKEY = Internal.createUniqueKey(OrganisationRoleType.ORGANISATION_ROLE_TYPE, DSL.name("organisation_role_type_pkey"), new TableField[] { OrganisationRoleType.ORGANISATION_ROLE_TYPE.SCHEME_ID, OrganisationRoleType.ORGANISATION_ROLE_TYPE.URI }, true);
    public static final UniqueKey<OrganisationRoleTypeSchemeRecord> ORGANISATION_ROLE_TYPE_SCHEME_PKEY = Internal.createUniqueKey(OrganisationRoleTypeScheme.ORGANISATION_ROLE_TYPE_SCHEME, DSL.name("organisation_role_type_scheme_pkey"), new TableField[] { OrganisationRoleTypeScheme.ORGANISATION_ROLE_TYPE_SCHEME.ID }, true);
    ...
    public static final ForeignKey<ContributorRoleTypeRecord, ContributorRoleTypeSchemeRecord> CONTRIBUTOR_ROLE_TYPE__FK_CONTRIBUTOR_ROLE_TYPE_SCHEME_ID = Internal.createForeignKey(ContributorRoleType.CONTRIBUTOR_ROLE_TYPE, DSL.name("fk_contributor_role_type_scheme_id"), new TableField[] { ContributorRoleType.CONTRIBUTOR_ROLE_TYPE.SCHEME_ID }, Keys.CONTRIBUTOR_ROLE_TYPE_SCHEME_PKEY, new TableField[] { ContributorRoleTypeScheme.CONTRIBUTOR_ROLE_TYPE_SCHEME.ID }, true);
    ...
    public static final ForeignKey<OrganisationRoleTypeRecord, OrganisationRoleTypeSchemeRecord> ORGANISATION_ROLE_TYPE__FK_ORGANISATION_ROLE_TYPE_SCHEME_ID = Internal.createForeignKey(OrganisationRoleType.ORGANISATION_ROLE_TYPE, DSL.name("fk_organisation_role_type_scheme_id"), new TableField[] { OrganisationRoleType.ORGANISATION_ROLE_TYPE.SCHEME_ID }, Keys.ORGANISATION_ROLE_TYPE_SCHEME_PKEY, new TableField[] { OrganisationRoleTypeScheme.ORGANISATION_ROLE_TYPE_SCHEME.ID }, true);
