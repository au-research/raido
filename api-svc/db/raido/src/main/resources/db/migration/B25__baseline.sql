...
--
-- Name: _; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA _;


ALTER SCHEMA _ OWNER TO postgres;
...
--
-- Name: api_svc; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA api_svc;


ALTER SCHEMA api_svc OWNER TO postgres;

--
-- Name: c; Type: SCHEMA; Schema: -; Owner: postgres
--
...
--
-- Name: i; Type: SCHEMA; Schema: -; Owner: postgres
--
...
--
-- Name: p; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA p;


ALTER SCHEMA p OWNER TO postgres;
...
--
-- Name: raid-v1-import; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA "raid-v1-import";


ALTER SCHEMA "raid-v1-import" OWNER TO postgres;

--
-- Name: raid_v1_import; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA raid_v1_import;


ALTER SCHEMA raid_v1_import OWNER TO postgres;
...
--
-- Name: v; Type: SCHEMA; Schema: -; Owner: postgres
--
...
--
-- Name: auth_request_status; Type: TYPE; Schema: a; Owner: postgres
--

CREATE TYPE a.auth_request_status AS ENUM (
    'REQUESTED',
    'APPROVED',
    'REJECTED'
);
...
ALTER TYPE a.auth_request_status OWNER TO postgres;

--
-- Name: id_provider; Type: TYPE; Schema: a; Owner: postgres
--

CREATE TYPE a.id_provider AS ENUM (
    'GOOGLE',
    'AAF',
    'RAIDO_API',
    'ORCID'
...
ALTER TYPE a.id_provider OWNER TO postgres;

--
-- Name: metaschema; Type: TYPE; Schema: a; Owner: postgres
--

CREATE TYPE a.metaschema AS ENUM (
    'raido-metadata-schema-v1',
    'legacy-metadata-schema-v1'
);


ALTER TYPE a.metaschema OWNER TO postgres;

--
-- Name: user_role; Type: TYPE; Schema: a; Owner: postgres
--

CREATE TYPE a.user_role AS ENUM (
    'OPERATOR',
    'SP_ADMIN',
    'SP_USER',
    'API'
...
ALTER TYPE a.user_role OWNER TO postgres;
...
--
-- Name: app_user; Type: TABLE; Schema: a; Owner: postgres
--

CREATE TABLE a.app_user (
    id bigint NOT NULL,
    service_point_id bigint NOT NULL,
    email character varying(256) NOT NULL,
    client_id character varying(256) NOT NULL,
    subject character varying(256) NOT NULL,
    id_provider a.id_provider NOT NULL,
    role a.user_role NOT NULL,
...
ALTER TABLE a.app_user OWNER TO postgres;

--
-- Name: COLUMN app_user.email; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.app_user.email IS 'should be renamed to "description" or some such.  api-keys do not and orcid 
  sign-ins might not have email address';


--
-- Name: COLUMN app_user.id_provider; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.app_user.id_provider IS 'not a real identity field, its just redundant info we figure it out from 
  the clientId or issuer and store it for easy analysis';


--
-- Name: COLUMN app_user.token_cutoff; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.app_user.token_cutoff IS 'Any endpoint call with a bearer token issued after this point will be 
  rejected. Any authentication attempt after this point will be rejected.';


--
-- Name: app_user_id_seq; Type: SEQUENCE; Schema: a; Owner: postgres
--

ALTER TABLE a.app_user ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME a.app_user_id_seq
...
--
-- Name: flyway_schema_history; Type: TABLE; Schema: a; Owner: postgres
--

CREATE TABLE a.flyway_schema_history (
...
ALTER TABLE a.flyway_schema_history OWNER TO postgres;

--
-- Name: raid; Type: TABLE; Schema: a; Owner: postgres
--
...
CREATE TABLE a.raid (
    ...
    metadata_schema a.metaschema NOT NULL,
...
ALTER TABLE a.raid OWNER TO postgres;

--
-- Name: COLUMN raid.url; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.raid.url IS 'The value that we set as the `URL` property via ARDC APIDS.
...
--
-- Name: COLUMN raid.url_index; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.raid.url_index IS 'The `index` of the URL property in APIDS. This can be different if we change
  how we mint URL values via APIDS.';


--
-- Name: COLUMN raid.metadata_schema; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.raid.metadata_schema IS 'Identifies the structure of the data in the metadata column';


--
-- Name: raido_operator; Type: TABLE; Schema: a; Owner: postgres
--

CREATE TABLE a.raido_operator (
    email character varying(256) NOT NULL
);


ALTER TABLE a.raido_operator OWNER TO postgres;

--
-- Name: TABLE raido_operator; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON TABLE a.raido_operator IS 'any app_user with an email in this table will be considered an operator';


--
-- Name: service_point; Type: TABLE; Schema: a; Owner: postgres
--

CREATE TABLE a.service_point (
    id bigint NOT NULL,
...
ALTER TABLE a.service_point OWNER TO postgres;

--
-- Name: COLUMN service_point.search_content; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.service_point.search_content IS 'Trimmed lowercase only';


--
-- Name: service_point_id_seq; Type: SEQUENCE; Schema: a; Owner: postgres
--

ALTER TABLE a.service_point ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME a.service_point_id_seq
    START WITH 20000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_authz_request; Type: TABLE; Schema: a; Owner: postgres
--

CREATE TABLE a.user_authz_request (
    id bigint NOT NULL,
    status a.auth_request_status NOT NULL,
    service_point_id bigint NOT NULL,
    email character varying(256) NOT NULL,
    client_id character varying(256) NOT NULL,
    id_provider a.id_provider NOT NULL,
...
ALTER TABLE a.user_authz_request OWNER TO postgres;

--
-- Name: COLUMN user_authz_request.email; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.user_authz_request.email IS 'Lowercase chars only - db enforced';


--
-- Name: COLUMN user_authz_request.responding_user; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.user_authz_request.responding_user IS 'user that approved or rejected, not set until that happens';


--
-- Name: COLUMN user_authz_request.approved_user; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.user_authz_request.approved_user IS 'the user that was approved, set when request is approved and the 
  user is created or updated';


--
-- Name: COLUMN user_authz_request.date_responded; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON COLUMN a.user_authz_request.date_responded IS 'not set until approved or rejected';


--
-- Name: user_authz_request_id_seq; Type: SEQUENCE; Schema: a; Owner: postgres
--

ALTER TABLE a.user_authz_request ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME a.user_authz_request_id_seq
    START WITH 30000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: flyway_schema_history; Type: TABLE; Schema: api_svc; Owner: postgres
--

CREATE TABLE api_svc.flyway_schema_history (
    installed_rank integer NOT NULL,
    version character varying(50),
    description character varying(200) NOT NULL,
    type character varying(20) NOT NULL,
...
ALTER TABLE api_svc.flyway_schema_history OWNER TO postgres;
...
--
-- Name: association_index; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.association_index (
...
ALTER TABLE raid_v1_import.association_index OWNER TO postgres;

--
-- Name: TABLE association_index; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON TABLE raid_v1_import.association_index IS 'imported from arn:aws:dynamodb:ap-southeast-2:005299621378:table/RAiD-RAiDLiveDB-1SX7NYTSOSUKX-AssociationIndexTable-1EMNYHDPK9NBP';


--
-- Name: COLUMN association_index.role; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON COLUMN raid_v1_import.association_index.role IS '`owner` - if type is `service`, otherwise not set';


--
-- Name: COLUMN association_index.type; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON COLUMN raid_v1_import.association_index.type IS '`service|institution` - 14K service, institution only 16';


--
-- Name: flyway_schema_history; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.flyway_schema_history (
    installed_rank integer NOT NULL,
    version character varying(50),
    description character varying(200) NOT NULL,
    type character varying(20) NOT NULL,
...
ALTER TABLE raid_v1_import.flyway_schema_history OWNER TO postgres;

--
-- Name: import_history; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.import_history (
...
ALTER TABLE raid_v1_import.import_history OWNER TO postgres;

--
-- Name: TABLE import_history; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON TABLE raid_v1_import.import_history IS 'history of data import runs';


--
-- Name: metadata; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.metadata (
    name text NOT NULL,
    type text NOT NULL,
    grid text NOT NULL,
    isni text NOT NULL,
...
ALTER TABLE raid_v1_import.metadata OWNER TO postgres;

--
-- Name: TABLE metadata; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON TABLE raid_v1_import.metadata IS 'from arn:aws:dynamodb:ap-southeast-2:005299621378:table/RAiD-MetadataTable-5X1IHWPICN82';


--
-- Name: raid; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.raid (
    handle text NOT NULL,
    owner text NOT NULL,
...
ALTER TABLE raid_v1_import.raid OWNER TO postgres;

--
-- Name: TABLE raid; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON TABLE raid_v1_import.raid IS 'imported from RAiD-RAiDLiveDB-1SX7NYTSOSUKX-RAiDTable-1PO1W2ASWY0OV';


--
-- Name: token; Type: TABLE; Schema: raid_v1_import; Owner: postgres
--

CREATE TABLE raid_v1_import.token (
    name text NOT NULL,
    environment text NOT NULL,
    date_created timestamp without time zone NOT NULL,
    token text NOT NULL,
...
ALTER TABLE raid_v1_import.token OWNER TO postgres;

--
-- Name: TABLE token; Type: COMMENT; Schema: raid_v1_import; Owner: postgres
--

COMMENT ON TABLE raid_v1_import.token IS 'from arn:aws:dynamodb:ap-southeast-2:005299621378:table/RAiD-TokenTable-1P6MFZ0WFEETH';
...
--
-- Data for Name: app_user; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.app_user (id, service_point_id, email, client_id, subject, id_provider, role, enabled, token_cutoff, date_created) FROM stdin;
\.


--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) FROM stdin;
0	\N	<< Flyway Schema Creation >>	SCHEMA	"a","p","i","_","s","v","c"	\N	postgres	2023-11-08 15:05:21.211446	0	t
1	2.1	api user permission	SQL	V2_1__api_user_permission.sql	-822148450	postgres	2023-11-08 15:11:15.748017	47	t
2	3	test table	SQL	V3__test_table.sql	-1326890727	postgres	2023-11-08 15:11:15.843998	18	t
3	4	sign in tables	SQL	V4__sign_in_tables.sql	-2070226286	postgres	2023-11-08 15:11:15.886057	138	t
4	5	raid tables	SQL	V5__raid_tables.sql	1904684198	postgres	2023-11-08 15:11:16.062786	30	t
\.


--
-- Data for Name: raid; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.raid (handle, service_point_id, url, url_index, primary_title, confidential, metadata_schema, metadata, start_date, date_created) FROM stdin;
\.


--
-- Data for Name: raido_operator; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.raido_operator (email) FROM stdin;
shorn.tolley@ardc.edu.au
...
--
-- Data for Name: service_point; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.service_point (id, name, search_content, admin_email, tech_email, enabled) FROM stdin;
20000000	raido	\N	web.services@ardc.edu.au	web.services@ardc.edu.au	t
\.


--
-- Data for Name: user_authz_request; Type: TABLE DATA; Schema: a; Owner: postgres
--

COPY a.user_authz_request (id, status, service_point_id, email, client_id, id_provider, subject, responding_user, approved_user, description, date_requested, date_responded) FROM stdin;
\.
...
--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: api_svc; Owner: postgres
--

COPY api_svc.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) FROM stdin;
1	2.1	api user permission	SQL	V2_1__api_user_permission.sql	-822148450	postgres	2023-11-09 10:29:11.628295	39	t
2	3	test table	SQL	V3__test_table.sql	-1326890727	postgres	2023-11-09 10:29:11.703356	19	t
3	4	sign in tables	SQL	V4__sign_in_tables.sql	-2070226286	postgres	2023-11-09 10:29:11.758225	142	t
4	5	raid tables	SQL	V5__raid_tables.sql	1904684198	postgres	2023-11-09 10:29:11.932369	40	t
5	6	import service points	SQL	V6__import_service_points.sql	1842604110	postgres	2023-11-09 10:29:12.002055	14	t
6	7	add-identifier-owner-to-service-point	SQL	V7__add-identifier-owner-to-service-point.sql	-1983714784	postgres	2023-11-09 10:29:12.042052	25	t
7	8	uq adv imaging service point	SQL	V8__uq_adv_imaging_service_point.sql	567043297	postgres	2023-11-09 10:29:12.096107	16	t
8	9	subject table	SQL	V9__subject_table.sql	-1847973086	postgres	2023-11-09 10:29:12.150104	23	t
9	10	related raid type table	SQL	V10__related_raid_type_table.sql	-565185645	postgres	2023-11-09 10:29:12.217372	25	t
10	11	related object type table	SQL	V11__related_object_type_table.sql	-97740436	postgres	2023-11-09 10:29:12.276874	19	t
11	12	lengthen handle column	SQL	V12__lengthen_handle_column.sql	186475150	postgres	2023-11-09 10:29:12.322993	13	t
12	13	add-editable-column-to-service-point	SQL	V13__add-editable-column-to-service-point.sql	-731584288	postgres	2023-11-09 10:29:12.360631	12	t
13	14	app writes enabled-not-null-in-service-point	SQL	V14__app_writes_enabled-not-null-in-service-point.sql	1946644893	postgres	2023-11-09 10:29:12.400194	13	t
14	15	list-raids-index-tx	SQL	V15__list-raids-index-tx.sql	-895095953	postgres	2023-11-09 10:29:12.441386	18	t
15	16	add version to raid	SQL	V16__add_version_to_raid.sql	801562196	postgres	2023-11-09 10:29:12.482408	13	t
16	17	remove operator-stolley	SQL	V17__remove_operator-stolley.sql	142519035	postgres	2023-11-09 10:29:12.518276	9	t
17	18	add extra schema types	SQL	V18__add_extra_schema_types.sql	1936141911	postgres	2023-11-09 10:29:12.55497	214	t
18	19	update related object type with version	SQL	V19__update_related_object_type_with_version.sql	-544556065	postgres	2023-11-09 10:29:12.789339	76	t
19	20	add steffen to raido operator	SQL	V20__add_steffen_to_raido_operator.sql	-99497486	postgres	2023-11-09 10:29:12.882601	6	t
20	21	language support	SQL	V21__language_support.sql	1124907340	postgres	2023-11-09 10:29:12.905556	179	t
21	22	subject data	SQL	V22__subject_data.sql	717699350	postgres	2023-11-09 10:29:13.186178	106	t
22	23	rename scheme to schema	SQL	V23__rename_scheme_to_schema.sql	1577807743	postgres	2023-11-09 10:29:13.379823	87	t
23	24	traditional knowledge labels	SQL	V24__traditional_knowledge_labels.sql	-1574838175	postgres	2023-11-09 10:29:13.492293	34	t
24	25	move-token-table	SQL	V25__move-token-table.sql	1844617455	postgres	2023-11-09 10:29:13.544973	20	t
\.
...
--
-- Data for Name: association_index; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.association_index (handle, owner_name, raid_name, role, type, start_date, s3_export) FROM stdin;
\.


--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) FROM stdin;
1	2	raid table	SQL	V2__raid_table.sql	-211590639	postgres	2023-11-09 10:29:10.811419	27	t
2	3	association-Index-table	SQL	V3__association-Index-table.sql	-1199871963	postgres	2023-11-09 10:29:10.878341	44	t
3	4	metadata-table	SQL	V4__metadata-table.sql	2066575100	postgres	2023-11-09 10:29:10.964996	21	t
4	5	token-table	SQL	V5__token-table.sql	-1959236621	postgres	2023-11-09 10:29:11.020086	23	t
5	6	import-history-table	SQL	V6__import-history-table.sql	1320993483	postgres	2023-11-09 10:29:11.077667	110	t
6	7	fix-token-table	SQL	V7__fix-token-table.sql	1649873417	postgres	2023-11-09 10:29:11.227216	18	t
\.


--
-- Data for Name: import_history; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.import_history (action_date, status, error, details) FROM stdin;
\.


--
-- Data for Name: metadata; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.metadata (name, type, grid, isni, admin_email, tech_email, s3_export) FROM stdin;
\.


--
-- Data for Name: raid; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.raid (handle, owner, content_path, content_index, name, description, start_date, creation_date, s3_export) FROM stdin;
\.


--
-- Data for Name: token; Type: TABLE DATA; Schema: raid_v1_import; Owner: postgres
--

COPY raid_v1_import.token (name, environment, date_created, token, s3_export) FROM stdin;
\.


--
-- Name: app_user_id_seq; Type: SEQUENCE SET; Schema: a; Owner: postgres
--

SELECT pg_catalog.setval('a.app_user_id_seq', 1000000000, false);


--
-- Name: service_point_id_seq; Type: SEQUENCE SET; Schema: a; Owner: postgres
--

SELECT pg_catalog.setval('a.service_point_id_seq', 20000001, true);


--
-- Name: user_authz_request_id_seq; Type: SEQUENCE SET; Schema: a; Owner: postgres
--

SELECT pg_catalog.setval('a.user_authz_request_id_seq', 30000000, false);
...
--
-- Name: app_user app_user_pkey; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.app_user
    ADD CONSTRAINT app_user_pkey PRIMARY KEY (id);


--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.flyway_schema_history
    ADD CONSTRAINT flyway_schema_history_pk PRIMARY KEY (installed_rank);


--
-- Name: raid raid_pkey; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.raid
    ADD CONSTRAINT raid_pkey PRIMARY KEY (handle);


--
-- Name: raido_operator raido_operator_pkey; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.raido_operator
    ADD CONSTRAINT raido_operator_pkey PRIMARY KEY (email);


--
-- Name: service_point service_point_pkey; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.service_point
    ADD CONSTRAINT service_point_pkey PRIMARY KEY (id);


--
-- Name: service_point unique_name; Type: CONSTRAINT; Schema: a; Owner: postgres
--
...
--
-- Name: CONSTRAINT unique_name ON service_point; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON CONSTRAINT unique_name ON a.service_point IS 'initially for uniqueness rather than querying, we want to retain the case
  entered by the user';


--
-- Name: user_authz_request user_authz_request_pkey; Type: CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.user_authz_request
...
--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: api_svc; Owner: postgres
--

ALTER TABLE ONLY api_svc.flyway_schema_history
    ADD CONSTRAINT flyway_schema_history_pk PRIMARY KEY (installed_rank);
...
--
-- Name: association_index association_index_pkey; Type: CONSTRAINT; Schema: raid_v1_import; Owner: postgres
--

ALTER TABLE ONLY raid_v1_import.association_index
    ADD CONSTRAINT association_index_pkey PRIMARY KEY (handle);


--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: raid_v1_import; Owner: postgres
--

ALTER TABLE ONLY raid_v1_import.flyway_schema_history
    ADD CONSTRAINT flyway_schema_history_pk PRIMARY KEY (installed_rank);


--
-- Name: metadata metadata_pkey; Type: CONSTRAINT; Schema: raid_v1_import; Owner: postgres
--

ALTER TABLE ONLY raid_v1_import.metadata
    ADD CONSTRAINT metadata_pkey PRIMARY KEY (name);


--
-- Name: raid raid_pkey; Type: CONSTRAINT; Schema: raid_v1_import; Owner: postgres
--

ALTER TABLE ONLY raid_v1_import.raid
    ADD CONSTRAINT raid_pkey PRIMARY KEY (handle);


--
-- Name: token token_pkey; Type: CONSTRAINT; Schema: raid_v1_import; Owner: postgres
--

ALTER TABLE ONLY raid_v1_import.token
    ADD CONSTRAINT token_pkey PRIMARY KEY (name, environment, date_created);


--
-- Name: app_user_id_fields_active_key; Type: INDEX; Schema: a; Owner: postgres
--

CREATE UNIQUE INDEX app_user_id_fields_active_key ON a.app_user USING btree (email, client_id, subject) WHERE (enabled = true);


--
-- Name: INDEX app_user_id_fields_active_key; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON INDEX a.app_user_id_fields_active_key IS 'a user can only be attached to one service point at a time.  We could change 
  this, but would need to change sign-in to specify service-point';


--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: a; Owner: postgres
--

CREATE INDEX flyway_schema_history_s_idx ON a.flyway_schema_history USING btree (success);


--
-- Name: user_authz_request_once_active_key; Type: INDEX; Schema: a; Owner: postgres
--

CREATE UNIQUE INDEX user_authz_request_once_active_key ON a.user_authz_request USING btree (service_point_id, client_id, subject) WHERE (status = 'REQUESTED'::a.auth_request_status);


--
-- Name: INDEX user_authz_request_once_active_key; Type: COMMENT; Schema: a; Owner: postgres
--

COMMENT ON INDEX a.user_authz_request_once_active_key IS 'a user can only make one active request per service point';
...
--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: api_svc; Owner: postgres
--

CREATE INDEX flyway_schema_history_s_idx ON api_svc.flyway_schema_history USING btree (success);
...
--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: raid_v1_import; Owner: postgres
--

CREATE INDEX flyway_schema_history_s_idx ON raid_v1_import.flyway_schema_history USING btree (success);


--
-- Name: app_user app_user_service_point_id_fkey; Type: FK CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.app_user
    ADD CONSTRAINT app_user_service_point_id_fkey FOREIGN KEY (service_point_id) REFERENCES a.service_point(id);


--
-- Name: raid raid_service_point_id_fkey; Type: FK CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.raid
    ADD CONSTRAINT raid_service_point_id_fkey FOREIGN KEY (service_point_id) REFERENCES a.service_point(id);


--
-- Name: user_authz_request user_authz_request_approved_user_fkey; Type: FK CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.user_authz_request
    ADD CONSTRAINT user_authz_request_approved_user_fkey FOREIGN KEY (approved_user) REFERENCES a.app_user(id);


--
-- Name: user_authz_request user_authz_request_responding_user_fkey; Type: FK CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.user_authz_request
    ADD CONSTRAINT user_authz_request_responding_user_fkey FOREIGN KEY (responding_user) REFERENCES a.app_user(id);


--
-- Name: user_authz_request user_authz_request_service_point_id_fkey; Type: FK CONSTRAINT; Schema: a; Owner: postgres
--

ALTER TABLE ONLY a.user_authz_request
    ADD CONSTRAINT user_authz_request_service_point_id_fkey FOREIGN KEY (service_point_id) REFERENCES a.service_point(id);
...
--
-- Name: SCHEMA raid_v1_import; Type: ACL; Schema: -; Owner: postgres
--
...
--
-- Name: TABLE flyway_schema_history; Type: ACL; Schema: api_svc; Owner: postgres
--

GRANT ALL ON TABLE api_svc.flyway_schema_history TO api_user;
...
--
-- Name: TABLE association_index; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.association_index TO api_user;


--
-- Name: TABLE flyway_schema_history; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.flyway_schema_history TO api_user;


--
-- Name: TABLE import_history; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.import_history TO api_user;


--
-- Name: TABLE metadata; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.metadata TO api_user;


--
-- Name: TABLE raid; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.raid TO api_user;


--
-- Name: TABLE token; Type: ACL; Schema: raid_v1_import; Owner: postgres
--

GRANT ALL ON TABLE raid_v1_import.token TO api_user;
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: raid_v1_import; Owner: postgres
--

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA raid_v1_import GRANT USAGE ON SEQUENCES TO api_user;


--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: raid_v1_import; Owner: postgres
--

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA raid_v1_import GRANT ALL ON TABLES TO api_user;
