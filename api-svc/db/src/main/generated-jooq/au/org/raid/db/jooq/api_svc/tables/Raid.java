...
public class Raid extends TableImpl<RaidRecord> {
     ...
     */
    public final TableField<RaidRecord, Metaschema> METADATA_SCHEMA = createField(DSL.name("metadata_schema"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(au.org.raid.db.jooq.api_svc.enums.Metaschema.class), this, "Identifies the structure of the data in the metadata column");
