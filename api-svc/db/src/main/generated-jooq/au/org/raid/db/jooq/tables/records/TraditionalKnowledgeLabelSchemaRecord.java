...
public class TraditionalKnowledgeLabelSchemaRecord extends UpdatableRecordImpl<TraditionalKnowledgeLabelSchemaRecord> implements Record2<Integer, String> {
    ...
    @Override
    public TraditionalKnowledgeLabelSchemaRecord values(Integer value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public TraditionalKnowledgeLabelSchemaRecord(Integer id, String uri) {
        super(TraditionalKnowledgeLabelSchema.TRADITIONAL_KNOWLEDGE_LABEL_SCHEMA);
