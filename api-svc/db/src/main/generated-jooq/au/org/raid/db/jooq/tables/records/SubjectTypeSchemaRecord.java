...
public class SubjectTypeSchemaRecord extends UpdatableRecordImpl<SubjectTypeSchemaRecord> implements Record3<Integer, String, SchemaStatus> {
    ...
    @Override
    public SubjectTypeSchemaRecord values(Integer value1, String value2, SchemaStatus value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SubjectTypeSchemaRecord(Integer id, String uri, SchemaStatus status) {
        super(SubjectTypeSchema.SUBJECT_TYPE_SCHEMA);
