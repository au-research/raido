...
public class AppUser extends TableImpl<AppUserRecord> {
     ...
     */
    public final TableField<AppUserRecord, IdProvider> ID_PROVIDER = createField(DSL.name("id_provider"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(au.org.raid.db.jooq.api_svc.enums.IdProvider.class), this, "not a real identity field, its just redundant info we figure it out from \n  the clientId or issuer and store it for easy analysis");

    /**
     * The column <code>api_svc.app_user.role</code>.
     */
    public final TableField<AppUserRecord, UserRole> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(au.org.raid.db.jooq.api_svc.enums.UserRole.class), this, "");
