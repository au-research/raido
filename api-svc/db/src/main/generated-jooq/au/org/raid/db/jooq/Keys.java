...
public class Keys {
    ...
    public static final UniqueKey<RaidHistoryRecord> RAID_HISTORY_PKEY = Internal.createUniqueKey(RaidHistory.RAID_HISTORY, DSL.name("raid_history_pkey"), new TableField[] { RaidHistory.RAID_HISTORY.HANDLE, RaidHistory.RAID_HISTORY.REVISION }, true);
