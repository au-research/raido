...
public class Keys {
    ...
    public static final ForeignKey<RaidDescriptionRecord, RaidRecord> RAID_DESCRIPTION__FK_DESCRIPTION_RAID_NAME = Internal.createForeignKey(RaidDescription.RAID_DESCRIPTION, DSL.name("fk_description_raid_name"), new TableField[] { RaidDescription.RAID_DESCRIPTION.RAID_NAME }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidTitleRecord, RaidRecord> RAID_TITLE__FK_TITLE_RAID_NAME = Internal.createForeignKey(RaidTitle.RAID_TITLE, DSL.name("fk_title_raid_name"), new TableField[] { RaidTitle.RAID_TITLE.RAID_NAME }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
