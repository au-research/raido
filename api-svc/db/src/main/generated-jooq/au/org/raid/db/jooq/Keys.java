...
public class Keys {
    ...
    public static final UniqueKey<RaidContributorRecord> RAID_CONTRIBUTOR_HANDLE_CONTRIBUTOR_ID_KEY = Internal.createUniqueKey(RaidContributor.RAID_CONTRIBUTOR, DSL.name("raid_contributor_handle_contributor_id_key"), new TableField[] { RaidContributor.RAID_CONTRIBUTOR.HANDLE, RaidContributor.RAID_CONTRIBUTOR.CONTRIBUTOR_ID }, true);
    ...
    public static final UniqueKey<RaidRelatedObjectRecord> RAID_RELATED_OBJECT_HANDLE_RELATED_OBJECT_ID_RELATED_OBJECT_KEY = Internal.createUniqueKey(RaidRelatedObject.RAID_RELATED_OBJECT, DSL.name("raid_related_object_handle_related_object_id_related_object_key"), new TableField[] { RaidRelatedObject.RAID_RELATED_OBJECT.HANDLE, RaidRelatedObject.RAID_RELATED_OBJECT.RELATED_OBJECT_ID, RaidRelatedObject.RAID_RELATED_OBJECT.RELATED_OBJECT_TYPE_ID }, true);
    ...
    public static final UniqueKey<RaidSubjectRecord> RAID_SUBJECT_HANDLE_SUBJECT_TYPE_ID_KEY = Internal.createUniqueKey(RaidSubject.RAID_SUBJECT, DSL.name("raid_subject_handle_subject_type_id_key"), new TableField[] { RaidSubject.RAID_SUBJECT.HANDLE, RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_ID }, true);
    ...
    public static final UniqueKey<TeamRecord> TEAM_PREFIX_KEY = Internal.createUniqueKey(Team.TEAM, DSL.name("team_prefix_key"), new TableField[] { Team.TEAM.PREFIX }, true);
    public static final UniqueKey<TeamUserRecord> TEAM_USER_APP_USER_ID_TEAM_ID_KEY = Internal.createUniqueKey(TeamUser.TEAM_USER, DSL.name("team_user_app_user_id_team_id_key"), new TableField[] { TeamUser.TEAM_USER.APP_USER_ID, TeamUser.TEAM_USER.TEAM_ID }, true);
    ...
    public static final ForeignKey<RaidAlternateIdentifierRecord, RaidRecord> RAID_ALTERNATE_IDENTIFIER__FK_RAID_ALTERNATE_IDENTIFIER_HANDLE = Internal.createForeignKey(RaidAlternateIdentifier.RAID_ALTERNATE_IDENTIFIER, DSL.name("fk_raid_alternate_identifier_handle"), new TableField[] { RaidAlternateIdentifier.RAID_ALTERNATE_IDENTIFIER.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    public static final ForeignKey<RaidAlternateUrlRecord, RaidRecord> RAID_ALTERNATE_URL__FK_RAID_ALTERNATE_URL_HANDLE = Internal.createForeignKey(RaidAlternateUrl.RAID_ALTERNATE_URL, DSL.name("fk_raid_alternate_url_handle"), new TableField[] { RaidAlternateUrl.RAID_ALTERNATE_URL.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidContributorRecord, RaidRecord> RAID_CONTRIBUTOR__FK_RAID_CONTRIBUTOR_HANDLE = Internal.createForeignKey(RaidContributor.RAID_CONTRIBUTOR, DSL.name("fk_raid_contributor_handle"), new TableField[] { RaidContributor.RAID_CONTRIBUTOR.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidDescriptionRecord, RaidRecord> RAID_DESCRIPTION__FK_DESCRIPTION_HANDLE = Internal.createForeignKey(RaidDescription.RAID_DESCRIPTION, DSL.name("fk_description_handle"), new TableField[] { RaidDescription.RAID_DESCRIPTION.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    public static final ForeignKey<RaidDescriptionRecord, LanguageRecord> RAID_DESCRIPTION__FK_DESCRIPTION_LANGUAGE_ID = Internal.createForeignKey(RaidDescription.RAID_DESCRIPTION, DSL.name("fk_description_language_id"), new TableField[] { RaidDescription.RAID_DESCRIPTION.LANGUAGE_ID }, Keys.LANGUAGE_NEW_PKEY, new TableField[] { Language.LANGUAGE.ID }, true);
    public static final ForeignKey<RaidDescriptionRecord, DescriptionTypeRecord> RAID_DESCRIPTION__FK_DESCRIPTION_TYPE = Internal.createForeignKey(RaidDescription.RAID_DESCRIPTION, DSL.name("fk_description_type"), new TableField[] { RaidDescription.RAID_DESCRIPTION.DESCRIPTION_TYPE_ID }, Keys.DESCRIPTION_TYPE_NEW_PKEY, new TableField[] { DescriptionType.DESCRIPTION_TYPE.ID }, true);
    ...
    public static final ForeignKey<RaidRelatedObjectRecord, RaidRecord> RAID_RELATED_OBJECT__FK_RAID_RELATED_OBJECT_HANDLE = Internal.createForeignKey(RaidRelatedObject.RAID_RELATED_OBJECT, DSL.name("fk_raid_related_object_handle"), new TableField[] { RaidRelatedObject.RAID_RELATED_OBJECT.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidSpatialCoverageRecord, RaidRecord> RAID_SPATIAL_COVERAGE__FK_RAID_SPATIAL_COVERAGE_HANDLE = Internal.createForeignKey(RaidSpatialCoverage.RAID_SPATIAL_COVERAGE, DSL.name("fk_raid_spatial_coverage_handle"), new TableField[] { RaidSpatialCoverage.RAID_SPATIAL_COVERAGE.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidSpatialCoveragePlaceRecord, LanguageRecord> RAID_SPATIAL_COVERAGE_PLACE__FK_RAID_SPATIAL_COVERAGE_PLACE_LANGUAGE_ID = Internal.createForeignKey(RaidSpatialCoveragePlace.RAID_SPATIAL_COVERAGE_PLACE, DSL.name("fk_raid_spatial_coverage_place_language_id"), new TableField[] { RaidSpatialCoveragePlace.RAID_SPATIAL_COVERAGE_PLACE.LANGUAGE_ID }, Keys.LANGUAGE_NEW_PKEY, new TableField[] { Language.LANGUAGE.ID }, true);
    public static final ForeignKey<RaidSpatialCoveragePlaceRecord, RaidSpatialCoverageRecord> RAID_SPATIAL_COVERAGE_PLACE__FK_RAID_SPATIAL_COVERAGE_PLACE_RAID_SPATIAL_COVERAGE_ID = Internal.createForeignKey(RaidSpatialCoveragePlace.RAID_SPATIAL_COVERAGE_PLACE, DSL.name("fk_raid_spatial_coverage_place_raid_spatial_coverage_id"), new TableField[] { RaidSpatialCoveragePlace.RAID_SPATIAL_COVERAGE_PLACE.RAID_SPATIAL_COVERAGE_ID }, Keys.RAID_SPATIAL_COVERAGE_PKEY, new TableField[] { RaidSpatialCoverage.RAID_SPATIAL_COVERAGE.ID }, true);
    public static final ForeignKey<RaidSubjectRecord, RaidRecord> RAID_SUBJECT__FK_RAID_SUBJECT_HANDLE = Internal.createForeignKey(RaidSubject.RAID_SUBJECT, DSL.name("fk_raid_subject_handle"), new TableField[] { RaidSubject.RAID_SUBJECT.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RaidTitleRecord, RaidRecord> RAID_TITLE__FK_TITLE_HANDLE = Internal.createForeignKey(RaidTitle.RAID_TITLE, DSL.name("fk_title_handle"), new TableField[] { RaidTitle.RAID_TITLE.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    public static final ForeignKey<RaidTitleRecord, LanguageRecord> RAID_TITLE__FK_TITLE_LANGUAGE_ID = Internal.createForeignKey(RaidTitle.RAID_TITLE, DSL.name("fk_title_language_id"), new TableField[] { RaidTitle.RAID_TITLE.LANGUAGE_ID }, Keys.LANGUAGE_NEW_PKEY, new TableField[] { Language.LANGUAGE.ID }, true);
    public static final ForeignKey<RaidTitleRecord, TitleTypeRecord> RAID_TITLE__FK_TITLE_TYPE = Internal.createForeignKey(RaidTitle.RAID_TITLE, DSL.name("fk_title_type"), new TableField[] { RaidTitle.RAID_TITLE.TITLE_TYPE_ID }, Keys.TITLE_TYPE_NEW_PKEY, new TableField[] { TitleType.TITLE_TYPE.ID }, true);
    public static final ForeignKey<RaidTraditionalKnowledgeLabelRecord, RaidRecord> RAID_TRADITIONAL_KNOWLEDGE_LABEL__FK_RAID_TRAD_KNOW_LABEL_HANDLE = Internal.createForeignKey(RaidTraditionalKnowledgeLabel.RAID_TRADITIONAL_KNOWLEDGE_LABEL, DSL.name("fk_raid_trad_know_label_handle"), new TableField[] { RaidTraditionalKnowledgeLabel.RAID_TRADITIONAL_KNOWLEDGE_LABEL.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<RelatedObjectRecord, RelatedObjectSchemaRecord> RELATED_OBJECT__FK_RELATED_OBJECT_SCHEMA_ID = Internal.createForeignKey(RelatedObject.RELATED_OBJECT, DSL.name("fk_related_object_schema_id"), new TableField[] { RelatedObject.RELATED_OBJECT.SCHEMA_ID }, Keys.RELATED_OBJECT_SCHEMA_PKEY, new TableField[] { RelatedObjectSchema.RELATED_OBJECT_SCHEMA.ID }, true);
    public static final ForeignKey<RelatedRaidRecord, RaidRecord> RELATED_RAID__FK_RELATED_RAID_HANDLE = Internal.createForeignKey(RelatedRaid.RELATED_RAID, DSL.name("fk_related_raid_handle"), new TableField[] { RelatedRaid.RELATED_RAID.HANDLE }, Keys.RAID_PKEY, new TableField[] { Raid.RAID.HANDLE }, true);
    ...
    public static final ForeignKey<TeamRecord, ServicePointRecord> TEAM__FK_TEAM_SERVICE_POINT_ID = Internal.createForeignKey(Team.TEAM, DSL.name("fk_team_service_point_id"), new TableField[] { Team.TEAM.SERVICE_POINT_ID }, Keys.SERVICE_POINT_PKEY, new TableField[] { ServicePoint.SERVICE_POINT.ID }, true);
    public static final ForeignKey<TeamUserRecord, AppUserRecord> TEAM_USER__FK_APP_USER_TEAM_APP_USER_ID = Internal.createForeignKey(TeamUser.TEAM_USER, DSL.name("fk_app_user_team_app_user_id"), new TableField[] { TeamUser.TEAM_USER.APP_USER_ID }, Keys.APP_USER_PKEY, new TableField[] { AppUser.APP_USER.ID }, true);
    public static final ForeignKey<TeamUserRecord, TeamRecord> TEAM_USER__FK_APP_USER_TEAM_TEAM_ID = Internal.createForeignKey(TeamUser.TEAM_USER, DSL.name("fk_app_user_team_team_id"), new TableField[] { TeamUser.TEAM_USER.TEAM_ID }, Keys.TEAM_PKEY, new TableField[] { Team.TEAM.ID }, true);
