...
public class Keys {
    ...
    public static final ForeignKey<TeamRecord, ServicePointRecord> TEAM__TEAM_SERVICE_POINT_ID_FKEY = Internal.createForeignKey(Team.TEAM, DSL.name("team_service_point_id_fkey"), new TableField[] { Team.TEAM.SERVICE_POINT_ID }, Keys.SERVICE_POINT_PKEY, new TableField[] { ServicePoint.SERVICE_POINT.ID }, true);
    public static final ForeignKey<TeamUserRecord, AppUserRecord> TEAM_USER__TEAM_USER_APP_USER_ID_FKEY = Internal.createForeignKey(TeamUser.TEAM_USER, DSL.name("team_user_app_user_id_fkey"), new TableField[] { TeamUser.TEAM_USER.APP_USER_ID }, Keys.APP_USER_PKEY, new TableField[] { AppUser.APP_USER.ID }, true);
    public static final ForeignKey<TeamUserRecord, TeamRecord> TEAM_USER__TEAM_USER_TEAM_ID_FKEY = Internal.createForeignKey(TeamUser.TEAM_USER, DSL.name("team_user_team_id_fkey"), new TableField[] { TeamUser.TEAM_USER.TEAM_ID }, Keys.TEAM_PKEY, new TableField[] { Team.TEAM.ID }, true);
