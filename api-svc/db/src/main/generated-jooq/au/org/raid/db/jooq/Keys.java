...
public class Keys {
    ...
    public static final UniqueKey<RaidSubjectRecord> RAID_SUBJECT_PKEY = Internal.createUniqueKey(RaidSubject.RAID_SUBJECT, DSL.name("raid_subject_pkey"), new TableField[] { RaidSubject.RAID_SUBJECT.RAID_NAME, RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_ID }, true);
    ...
    public static final UniqueKey<SpatialCoverageSchemaRecord> SPATIAL_COVERAGE_SCHEMA_SCHEMA_URI_KEY = Internal.createUniqueKey(SpatialCoverageSchema.SPATIAL_COVERAGE_SCHEMA, DSL.name("spatial_coverage_schema_schema_uri_key"), new TableField[] { SpatialCoverageSchema.SPATIAL_COVERAGE_SCHEMA.SCHEMA_URI }, true);
    ...
    public static final ForeignKey<RaidSpatialCoverageRecord, LanguageRecord> RAID_SPATIAL_COVERAGE__FK_RAID_SPATIAL_COVERAGE_PLACE_LANGUAGE_ID = Internal.createForeignKey(RaidSpatialCoverage.RAID_SPATIAL_COVERAGE, DSL.name("fk_raid_spatial_coverage_place_language_id"), new TableField[] { RaidSpatialCoverage.RAID_SPATIAL_COVERAGE.PLACE_LANGUAGE_ID }, Keys.LANGUAGE_NEW_PKEY, new TableField[] { Language.LANGUAGE.ID }, true);
    ...
    public static final ForeignKey<RaidSubjectRecord, LanguageRecord> RAID_SUBJECT__FK_RAID_SUBJECT_KEYWORD_LANGUAGE_ID = Internal.createForeignKey(RaidSubject.RAID_SUBJECT, DSL.name("fk_raid_subject_keyword_language_id"), new TableField[] { RaidSubject.RAID_SUBJECT.KEYWORD_LANGUAGE_ID }, Keys.LANGUAGE_NEW_PKEY, new TableField[] { Language.LANGUAGE.ID }, true);
